...
def main() -> None:
    ...
    diffusion = GaussianDiffusion(
        ...
        parameterization=cfg.diff_parameterization, sampler=cfg.diff_sampler,
        ddim_steps=cfg.diff_ddim_steps, ddim_eta=cfg.diff_ddim_eta,
    ).to(device)
    ...
    save_checkpoint(
        ...
        model_config=dict(
            ...
            schedule=cfg.diff_schedule, parameterization=cfg.diff_parameterization,
            sampler=cfg.diff_sampler, ddim_steps=cfg.diff_ddim_steps, ddim_eta=cfg.diff_ddim_eta,
        ),
